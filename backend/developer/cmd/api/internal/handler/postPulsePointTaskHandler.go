...
func postPulsePointTaskHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := logic.NewPostPulsePointTaskLogic(r.Context(), svcCtx)
		resp, err := l.PostPulsePointTask(rayId, &req)
