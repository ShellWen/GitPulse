...
func postRegionTaskHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := logic.NewPostRegionTaskLogic(r.Context(), svcCtx)
		resp, err := l.PostRegionTask(rayId, &req)
