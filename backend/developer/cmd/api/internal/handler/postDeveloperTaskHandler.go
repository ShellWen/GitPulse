...
func postDeveloperTaskHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := logic.NewPostDeveloperTaskLogic(r.Context(), svcCtx)
		resp, err := l.PostDeveloperTask(rayId, &req)
