...
type PostRegionTaskLogic struct {
	logx.Logger
	ctx    context.Context
	svcCtx *svc.ServiceContext
}

func NewPostRegionTaskLogic(ctx context.Context, svcCtx *svc.ServiceContext) *PostRegionTaskLogic {
	return &PostRegionTaskLogic{
...
func (l *PostRegionTaskLogic) PostRegionTask(rayId string, req *types.PostTaskReq) (*types.TaskId, error) {
	...
	task, taskId, err := tasks.NewAPITask(tasks.APIGetRegion, id, reqId)
	if err != nil {
