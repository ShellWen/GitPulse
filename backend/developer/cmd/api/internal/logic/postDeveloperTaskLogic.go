...
func NewPostDeveloperTaskLogic(ctx context.Context, svcCtx *svc.ServiceContext) *PostDeveloperTaskLogic {
	return &PostDeveloperTaskLogic{
...
func (l *PostDeveloperTaskLogic) PostDeveloperTask(rayId string, req *types.PostTaskReq) (*types.TaskId, error) {
	...
	task, taskId, err := tasks.NewAPITask(tasks.APIGetDeveloper, id, reqId)
	if err != nil {
